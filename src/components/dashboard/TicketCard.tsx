...
const TicketCard: React.FC<TicketCardProps> = ({ booking }) => {
  ...
  return (
    <motion.div
      ...
      className={`group relative w-full bg-white rounded-[32px] overflow-hidden flex flex-col md:flex-row shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-gray-100 ${isRefunded ? 'opacity-90' : ''}`}
    >
      {/* Top Gradient Strip */}
