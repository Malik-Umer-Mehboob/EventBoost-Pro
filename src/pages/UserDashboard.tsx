    ...
    <div className="min-h-screen bg-slate-50 pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div 
          ...
          className="bg-white p-8 sm:p-10 rounded-[40px] mb-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100"
        >
        ...
        <div className="space-y-6">
          {loading ? (
            ...
            <div className="text-center py-24 bg-white rounded-[32px] border-2 border-dashed border-gray-200 shadow-sm">
